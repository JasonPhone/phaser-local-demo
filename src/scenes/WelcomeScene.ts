...
export class WelcomeScene extends Phaser.Scene {
    ...
    create(data: any) {
        ...
        this.role_ADC = this.add.sprite(200, 350, "playerADC").setScale(2).setInteractive();
        this.role_SUP = this.add.sprite(400, 350, "playerSUP").setScale(2).setInteractive();
        this.role_TNK = this.add.sprite(600, 350, "playerTNK").setScale(2).setInteractive();
    ...
    update(time: number, delta: number): void {
        ...
        if (this.player_info.role === RoleType.ADC) {
            this.draw_indicator(this.role_indicator, 137, 282, 125, 125);
        } else if (this.player_info.role === RoleType.SUP) {
            this.draw_indicator(this.role_indicator, 337, 282, 125, 125);
        } else if (this.player_info.role === RoleType.TNK) {
            this.draw_indicator(this.role_indicator, 537, 282, 125, 125);
        }
    }
    ...
    draw_role_property() {
        // adc
        this.draw_bar(135, 420, "攻", 0.8);
        this.draw_bar(135, 460, "防", 0.5);
        this.draw_bar(135, 500, "速", 0.7);
        // sup 
        this.draw_bar(335, 420, "攻", 0.6);
        this.draw_bar(335, 460, "防", 0.5);
        this.draw_bar(335, 500, "速", 0.7);
        // tnk
        this.draw_bar(535, 420, "攻", 0.6);
        this.draw_bar(535, 460, "防", 0.7);
        this.draw_bar(535, 500, "速", 0.6);
    }
